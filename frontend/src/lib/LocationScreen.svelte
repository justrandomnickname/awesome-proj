<script lang="ts">
  ...
  import { GetCurrentLocation, PerformPlayerAction, GetCurrentPoint, GetAvailableConnections, MoveToPoint } from '../../wailsjs/go/app/App.js';
        ...
        <div class="interactions-content">
          ...
          <div class="navigation-section">
            ...
            <div class="current-point">
              <strong>Текущая локация:</strong> {currentPoint.name}
              <p class="point-description">{currentPoint.description}</p>
              <span class="point-type point-type-{currentPoint.type}">{currentPoint.type}</span>
            </div>
...
<style>
  ...
  .connections-grid {
    display: grid;
    grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); /* Увеличиваем минимальную ширину */
